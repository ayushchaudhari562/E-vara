...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Why standard corporate cybersecurity is no longer enough to protect the C-suite in a hyper-connected world.",
    date: "2026-06-12",
  ...
  },
  {
    ...
    excerpt:
      "High-Net-Worth Individuals (HNWIs) face unique threats that standard enterprise security software completely ignores.",
    date: "2026-06-10",
  ...
  },
  {
    ...
    excerpt:
      "How we analyze massive amounts of sensitive identity data without compromising executive privacy.",
    date: "2026-06-08",
  ...
  },
  {
    ...
    excerpt:
      "Actionable steps every founder and operator should take today to minimize their exposure.",
    date: "2026-06-05",
    author: "E-VARA Threat Lab",
    readTime: "7 min read",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "A deep dive into the technology behind E-VARA's real-time threat intelligence ingestion engine.",
    date: "2026-06-01",
    author: "E-VARA Engineering",
    readTime: "5 min read",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "Founders often sacrifice personal privacy for business visibility. Here is how to navigate the modern threat landscape.",
    date: "2026-05-28",
    author: "E-VARA Intelligence Team",
    readTime: "4 min read",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "How Large Language Models are revolutionizing the way we interpret and respond to cyber threats.",
    date: "2026-05-25",
    author: "E-VARA Engineering",
    readTime: "6 min read",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "An analysis of the most common ways executive devices are compromised, and how to harden them.",
    date: "2026-05-20",
    author: "E-VARA Threat Lab",
    readTime: "5 min read",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "A technical look at how modern browsers enable military-grade encryption directly in the client.",
    date: "2026-05-15",
    author: "E-VARA Engineering",
    readTime: "8 min read",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "Put on the black hat. Discover the tools and techniques attackers use to map your digital life.",
    date: "2026-05-10",
    author: "E-VARA Threat Lab",
    readTime: "6 min read",
    content: `
